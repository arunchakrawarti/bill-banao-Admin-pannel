...
const GSTR9Table = () => {
  return (
    <div className="space-y-6  mt-6">
      ...
      {/* Summary Cards */}
      <div className="w-full p-4 sm:p-6 bg-white rounded-xl shadow space-y-6">
        ...
        <div className="flex flex-wrap gap-3 mt-4">
          ...
          <Button variant="outline" className="w-full sm:w-auto">View Audit Trail</Button>
          <Button variant="outline" className="w-full sm:w-auto">Generate Reconciliation Report</Button>
          <Button variant="default" className="w-full sm:w-auto bg-purple-600 hover:bg-purple-700 text-white">
            Save Offline
          </Button>
        </div>
      </div>
